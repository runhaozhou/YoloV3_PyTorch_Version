...
class YoloDataset(Dataset):
    ...
    def get_random_data(self, annotation_line, input_shape, jitter=.3, hue=.1, sat=1.5, val=1.5, random=True):
        """Stochastic pre-processing for real-time data enhancement"""
        ...
        if not random:
            ...
            # Adjusting the coordinates of the target BBox
    ...
    def __getitem__(self, index):
        ...
        if len(y) != 0:
            # Convert coordinates to percentages from 0 to 1
...
# Deploy collate_fn in DataLoader
